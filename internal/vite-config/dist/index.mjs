...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben/vite-config": "/Users/sunn/code/self/open-oj/open-oj-admin/internal/vite-config"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("/Users/sunn/code/self/open-oj/open-oj-admin/internal/vite-config/src/index.js")} */
const _module = await jiti.import("/Users/sunn/code/self/open-oj/open-oj-admin/internal/vite-config/src/index.ts");
