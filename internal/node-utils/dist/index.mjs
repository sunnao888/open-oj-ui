...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben/node-utils": "/Users/sunn/code/self/open-oj/open-oj-admin/internal/node-utils"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("/Users/sunn/code/self/open-oj/open-oj-admin/internal/node-utils/src/index.js")} */
const _module = await jiti.import("/Users/sunn/code/self/open-oj/open-oj-admin/internal/node-utils/src/index.ts");
