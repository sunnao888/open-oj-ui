...
/** 编辑题目 */
function handleEdit(row: QuestionApi.Question) {
...
async function handleExport() {
  const data = await exportQuestion(await gridApi.formApi.getValues());
  downloadFileFromBlobPart({ fileName: '题目.xls', source: data });
}
