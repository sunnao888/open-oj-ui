...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben-core/shared": "/Users/sunn/code/self/open-oj/open-oj-ui/packages/@core/base/shared"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("/Users/sunn/code/self/open-oj/open-oj-ui/packages/@core/base/shared/src/utils/index.js")} */
const _module = await jiti.import("/Users/sunn/code/self/open-oj/open-oj-ui/packages/@core/base/shared/src/utils/index.ts");
...
export const dataURLtoBlob = _module.dataURLtoBlob;
...
export const rangePickerExtend = _module.rangePickerExtend;
export const to = _module.to;
export const U = _module.U;
export const filterTree = _module.filterTree;
export const handleTree = _module.handleTree;
...
export const buildUUID = _module.buildUUID;
export const buildShortUUID = _module.buildShortUUID;
