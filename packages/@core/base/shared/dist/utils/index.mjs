...
/** @type {import("/Users/sunn/code/self/open-oj/open-oj-admin/packages/@core/base/shared/src/utils/index.js")} */
const _module = await jiti.import("/Users/sunn/code/self/open-oj/open-oj-admin/packages/@core/base/shared/src/utils/index.ts");
