...
/** @type {import("/Users/sunn/code/self/open-oj/open-oj-ui/packages/@core/base/shared/src/store.js")} */
const _module = await jiti.import("/Users/sunn/code/self/open-oj/open-oj-ui/packages/@core/base/shared/src/store.ts");
